  ...
  return (
    <footer className="Footer">
      <div className="text-attribution">
        ...
        <span>
          Coded in VSCode with Typescript React. Deployed with Vercel. Typeface
          is Fira Sans and Fira Mono via Google Fonts.
        </span>
      </div>
      <div className="scrolling-motto">
        <div className="motto-text-container">
          <div key={`${MOTTOS[mottoIdx]}-one`} className="motto-text">
            {MOTTOS[mottoIdx]}
          </div>
        ...
        <button
          ...
          onClick={() =>
            setMottoIdx((prevMottoIdx) => (prevMottoIdx + 1) % MOTTOS.length)
          }
        >
          <ArrowsCrossedSvg />
        </button>
